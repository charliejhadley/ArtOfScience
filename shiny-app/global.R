...
image_1 <- image_read(here::here("shiny-app/image-1.png"))

image_2 <- image_read(here::here("shiny-app/image-2.png"))

image_3 <- image_read(here::here("shiny-app/image-3.png"))

# image_write(image_3,
#             here::here("shiny-app/image-3_low-quality.jpg"),
#             density = "72x72")
# 
# image_convert(image_3, format = "png") %>% 
#   image_write(here::here("shiny-app/image-3_covert-maybe.png"),
#               density = "50x50")
